        ...
        <div className='carriage-seats d-flex justify-content-evenly'>
          <div className="seats-third-space">
            ...
            <div className="seats-space__bottom d-flex justify-content-evenly">
              <div className='seat-item-third'>25</div>
              <div className='seat-item-third'>26</div>
            </div>
          </div>
          <div className="seats-third-space">
            <div className="seats-space__top d-flex flex-column-reverse flex-wrap">
            ...
            <div className="seats-space__bottom d-flex justify-content-evenly">
              <div className='seat-item-third'>27</div>
              <div className='seat-item-third'>28</div>
            </div>
          </div>
          <div className="seats-third-space">
            <div className="seats-space__top  d-flex flex-column-reverse flex-wrap">
            ...
            <div className="seats-space__bottom d-flex justify-content-evenly">
              <div className='seat-item-third'>29</div>
              <div className='seat-item-third'>30</div>
            </div>
          </div>
          <div className="seats-third-space">
            <div className="seats-space__top d-flex flex-column-reverse flex-wrap">
            ...
            <div className="seats-space__bottom d-flex justify-content-evenly">
              <div className='seat-item-third'>31</div>
              <div className='seat-item-third'>32</div>
            </div>
          </div>
          <div className="seats-third-space">
            <div className="seats-space__top d-flex flex-column-reverse flex-wrap">
            ...
            <div className="seats-space__bottom d-flex justify-content-evenly">
              <div className='seat-item-third'></div>
              <div className='seat-item-third'></div>
            </div>
          </div>
          <div className="seats-third-space">
